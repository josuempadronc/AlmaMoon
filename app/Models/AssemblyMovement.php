 ...
 */
class AssemblyMovement extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['date','typeMovement_id','order','note','finishedProduct_id','amount','color_id','origin_id','movementDeatil_id','location_id','observation'];

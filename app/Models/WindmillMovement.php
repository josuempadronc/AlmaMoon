 ...
 */
class WindmillMovement extends Model
{
     ...
     * @var array
     */
    protected $fillable = ['date','typeMovement_id','note','order','Product','amount','measures_id','origin_id','observation'];

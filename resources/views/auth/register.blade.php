        ...
        <div class="row justify-content-center pt-5">
            <div class="col-md-8 pt-5 mt-5">
                <div class="card px-5 mt-1 w-50"
                    ...
                    "
                    id="login">
                    <img src="./images/logo.png" style="position:relative; margin-left: 40%; width: 30%;">
                    <div class="card-body mt-3">
                        ...
                        >
                            ...
                            <div class="row mb-3">
                                <label for="password"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Consaseña') }}</label>

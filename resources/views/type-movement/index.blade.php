                            ...
                            <div class="float-right">
                                @auth
                                    @if (auth()->user()->role === '1')
                                        ...
                                        <a href="{{ route('type-movements.create') }}"
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @auth
                                                            @if (auth()->user()->role === '1')
                                                                <form
                                                                    action="{{ route('type-movements.destroy', $typeMovement->id) }}"
                                                                    method="POST">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="exampleModalLabel">Importar Tipos de Movimiento</h1>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form action="{{ route('typeMovement.import') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <input type="file" name="TiposMovimientos" accept=".txt">

    ...
    <div class="box-body">
        <div class="row">
            <div class="col">
                <div class="form-group">
                    {{ Form::label('Producto') }}
                    {{ Form::text('finishedProduct_id',$progressAssambly->finishedProduct_id, ['class' => 'form-control' . ($errors->has('Producto') ? ' is-invalid' : ''), 'placeholder' => 'Producto']) }}
        ...
        <div class="row">
            <div class="col">
                <div class="form-group">
                    {{ Form::label('nota') }}
                    {{ Form::text('nota', $progressAssambly->nota, ['class' => 'form-control' . ($errors->has('nota') ? ' is-invalid' : ''), 'placeholder' => 'Nota']) }}

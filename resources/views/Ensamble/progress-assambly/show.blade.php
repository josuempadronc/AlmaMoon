                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ $progressAssambly->product->name }}" disabled readonly>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" value="{{ $progressAssambly->nota }}" disabled readonly>
                                    </div>
                                </div>
                                <div class="col">
                                    <div class="mb-3">
